...
export default function PopularBox() {
    return (
        <div className="group grid max-h-[450px] w-full grid-rows-[70%_30%] overflow-hidden rounded-2xl border border-zinc-200 bg-zinc-50 shadow-lg transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-orange-500/10 sm:max-w-[350px]">
            {/* Image */}
